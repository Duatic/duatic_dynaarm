...
This package contains the xacro/urdf description file for the [Duatic DynaArms](https://duatic.com/robotic-arm/). The official ROS2 driver can be found in the [duatic_dynaarm_driver](https://github.com/Duatic/duatic_dynaarm_driver/) repository.
...
| corydoras12 | First DynaArm with brake support; identical to the `baracuda12` in dimensions and configuration, differing only in brake functionality |
